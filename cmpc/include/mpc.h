 ...
 * at run-time, by setting both the ctl.x_ref and ctl.u_ref pointers to point
 * to an array of appropriate size (MPC_HOR_STATES, and MPC_HOR_INPUTS, 
 * respectively). If any of them is the zero pointer (NULL), the cases 
 * of regulation of the origin are considered.
 * 
